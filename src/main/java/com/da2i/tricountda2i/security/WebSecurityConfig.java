...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        httpSecurity.csrf().disable()
                ...
                .antMatchers("/api/public/participants","/api/authenticate","/api/register","/api/swagger-ui.html/**", "/api/configuration/**", "/api/swagger-resources/**", "/api/v2/api-docs","/api/webjars/**")
                .permitAll().
